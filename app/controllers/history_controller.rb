...
def y_right
 ...
 # g.title( 'Fertility Cycle #1', '{color: #7E97A6; font-size: 18; text-align: center}' )
  ...
  max_entry = (entries.last.chart_date.to_date - @user.current_cycle.created_at.to_date).to_i
  ...
  for entry in entries
    day = (entry.chart_date.to_date - @user.current_cycle.created_at.to_date).to_i
